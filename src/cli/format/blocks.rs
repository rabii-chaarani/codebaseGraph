...
pub(in crate::cli) fn query_columns(statement: &str) -> Vec<String> {
...
pub(in crate::cli) fn split_return_expressions(text: &str) -> Vec<String> {
...
pub(in crate::cli) fn query_column_label(expression: &str) -> Option<String> {
...
pub(in crate::cli) fn is_identifier(value: &str) -> bool {
...
pub(in crate::cli) fn block_json_value(value: &serde_json::Value) -> String {
    match value {
...
pub(in crate::cli) fn block_span(value: Option<&serde_json::Value>) -> String {
...
pub(in crate::cli) fn append_query_spec_lines(
...
pub(in crate::cli) fn value_bool(payload: &serde_json::Value, key: &str) -> bool {
    payload
        .get(key)
...
pub(in crate::cli) fn csv_names(values: &[serde_json::Value]) -> String {
    values
        .iter()
...
pub(in crate::cli) fn csv_values(value: Option<&serde_json::Value>) -> String {
    value
        .and_then(serde_json::Value::as_array)
        .map(|values| {
            values
