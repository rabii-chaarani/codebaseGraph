...
pub(in crate::product_cli) use command::run_watch;
pub(in crate::product_cli) use filter::WatchEventFilter;
pub(in crate::product_cli) use options::{SetupOptions, WatchLoopConfig};
pub(in crate::product_cli) use snapshot::scan_source_snapshots;
