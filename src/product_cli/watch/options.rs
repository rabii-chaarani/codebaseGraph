use crate::product_cli::{
    format::setup_help, install::supported_install_clients, materialize::MaterializeOptions,
};
use std::path::PathBuf;

#[derive(Debug)]
pub(in crate::product_cli) struct WatchOptions {
    pub(in crate::product_cli) materialize: MaterializeOptions,
    pub(in crate::product_cli) backend: WatchBackend,
    pub(in crate::product_cli) poll_ms: u64,
    pub(in crate::product_cli) debounce_ms: u64,
    pub(in crate::product_cli) max_iterations: Option<usize>,
    pub(in crate::product_cli) once: bool,
    pub(in crate::product_cli) help: bool,
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::product_cli) enum WatchBackend {
    Auto,
    Native,
    Poll,
}
...
pub(in crate::product_cli) struct WatchLoopConfig {
    pub(in crate::product_cli) poll_ms: u64,
    pub(in crate::product_cli) debounce_ms: u64,
    pub(in crate::product_cli) max_iterations: Option<usize>,
}
...
impl WatchBackend {
    pub(in crate::product_cli) fn parse(value: &str) -> Result<Self, String> {
        match value {
            "auto" => Ok(Self::Auto),
...
#[derive(Debug)]
pub(in crate::product_cli) struct SetupOptions {
    pub(in crate::product_cli) repo_root: PathBuf,
    pub(in crate::product_cli) mode: String,
    pub(in crate::product_cli) include_fts: bool,
    pub(in crate::product_cli) semantic_enrichment: bool,
    pub(in crate::product_cli) semantic_provider_mode: String,
    pub(in crate::product_cli) mcp_client: String,
    pub(in crate::product_cli) mcp_config_path: Option<PathBuf>,
    pub(in crate::product_cli) skip_mcp_config: bool,
    pub(in crate::product_cli) dry_run: bool,
    pub(in crate::product_cli) instructions_target: String,
    pub(in crate::product_cli) help: bool,
}
