...
use crate::product_cli::{constants::GRAPH_SCHEMA_JSON, graph::cypher_single_quoted};
use std::collections::BTreeSet;

pub(in crate::product_cli) fn schema_statements_from_copy_statements(
    include_fts: bool,
...
pub(in crate::product_cli) fn fts_index_statements(node_tables: &[String]) -> Vec<String> {
...
pub(in crate::product_cli) fn copy_tables(copy_statements: &[String]) -> BTreeSet<String> {
    copy_statements
        .iter()
...
pub(in crate::product_cli) fn relation_names(tables: &BTreeSet<String>) -> BTreeSet<String> {
...
pub(in crate::product_cli) fn node_table_sql(
    table: &str,
...
pub(in crate::product_cli) fn relation_table_sql(
    table: &str,
    from_tables: &[String],
    to_tables: &[String],
    role: &str,
...
pub(in crate::product_cli) fn node_fields(table: &str) -> Vec<(&'static str, &'static str)> {
...
pub(in crate::product_cli) fn common_node_fields() -> Vec<(&'static str, &'static str)> {
    vec![
        ("id", "STRING"),
        ("label", "STRING"),
        ("kind", "STRING"),
...
pub(in crate::product_cli) fn edge_fields() -> Vec<(&'static str, &'static str)> {
    vec![
        ("id", "STRING"),
        ("kind", "STRING"),
        ("source_id", "STRING"),
