...
#[derive(Debug, Clone)]
pub(in crate::product_cli) struct NativeMcpDescriptor {
    pub(in crate::product_cli) name: String,
    pub(in crate::product_cli) command: String,
    pub(in crate::product_cli) args: Vec<String>,
    pub(in crate::product_cli) setup_config_path: String,
    pub(in crate::product_cli) repo_root: String,
    pub(in crate::product_cli) timeout: u64,
}

impl NativeMcpDescriptor {
    pub(in crate::product_cli) fn as_json(&self) -> serde_json::Value {
        json!({
            "name": self.name,
            "transport": "stdio",
    ...
    pub(in crate::product_cli) fn stdio_entry(
        &self,
        include_type: bool,
...
pub(in crate::product_cli) fn build_mcp_descriptor(
...
pub(in crate::product_cli) fn install_safe_name(value: &str) -> String {
