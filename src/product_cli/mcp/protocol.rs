...
pub(in crate::product_cli) fn handle_mcp_message(
...
pub(in crate::product_cli) fn parse_mcp_payload(data: &[u8]) -> Result<serde_json::Value, String> {
...
pub(in crate::product_cli) fn negotiate_protocol_version(requested: &str) -> String {
    match requested {
...
pub(in crate::product_cli) fn rpc_error(
...
pub(in crate::product_cli) fn is_supported_protocol_version(version: &str) -> bool {
    matches!(
        version,
...
pub(in crate::product_cli) struct McpSession {
    pub(in crate::product_cli) protocol_version: Option<String>,
    pub(in crate::product_cli) initialized: bool,
}
