...
pub(in crate::product_cli) fn serve_mcp_stdio<R: BufRead, W: Write>(
    options: &McpServeOptions,
    mut input: R,
    output: &mut W,
) -> Result<(), String> {
...
pub(in crate::product_cli) fn read_mcp_message<R: BufRead, W: Write>(
    input: &mut R,
    output: &mut W,
...
pub(in crate::product_cli) fn log_mcp_stdio_parse_error(error: &str) {
    eprintln!(
        "{}",
        json!({
...
pub(in crate::product_cli) fn write_mcp_message<W: Write>(
    output: &mut W,
