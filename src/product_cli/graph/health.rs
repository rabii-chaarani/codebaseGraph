...
use crate::product_cli::{setup::GraphStatePaths, util::read_json_file};
use lbug::{Connection, Database, SystemConfig, Value};
use std::path::{Path, PathBuf};

#[derive(Debug)]
pub(in crate::product_cli) struct HealthRuntime {
    pub(in crate::product_cli) repo_root: PathBuf,
    pub(in crate::product_cli) db_path: PathBuf,
    pub(in crate::product_cli) manifest_path: PathBuf,
}

pub(in crate::product_cli) fn resolve_health_runtime(
...
pub(in crate::product_cli) fn count_graph_nodes(db_path: &Path) -> Result<u64, String> {
...
pub(in crate::product_cli) fn value_to_u64(value: &Value) -> Option<u64> {
    match value {
