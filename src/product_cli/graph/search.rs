...
pub(in crate::product_cli) fn execute_graph_search(
    db_path: &Path,
    options: &GraphSearchOptions,
...
pub(in crate::product_cli) fn execute_graph_context(
    db_path: &Path,
    node_id: &str,
    node_type: &str,
    options: &GraphSearchOptions,
...
pub(in crate::product_cli) fn query_relation_neighbors(
    conn: &Connection,
...
pub(in crate::product_cli) fn relation_type<'a>(
...
pub(in crate::product_cli) fn neighbor_statement(
    node_type: &str,
    neighbor_type: &str,
    relation: &str,
    direction: &str,
...
pub(in crate::product_cli) fn search_fts_index(
    conn: &Connection,
    node_type: &str,
    index_name: &str,
    query: &str,
...
pub(in crate::product_cli) fn is_missing_search_target_error(error: &str) -> bool {
...
#[derive(Debug, Clone)]
pub(in crate::product_cli) struct SearchHitRow {
    pub(in crate::product_cli) id: String,
    pub(in crate::product_cli) node_type: String,
    pub(in crate::product_cli) label: String,
    pub(in crate::product_cli) qualified_name: String,
    pub(in crate::product_cli) path: String,
    pub(in crate::product_cli) line_start: Option<i64>,
    pub(in crate::product_cli) line_end: Option<i64>,
    pub(in crate::product_cli) summary: String,
    pub(in crate::product_cli) score: f64,
    pub(in crate::product_cli) rank_score: f64,
    pub(in crate::product_cli) index_order: usize,
}

impl SearchHitRow {
    pub(in crate::product_cli) fn into_json(
        self,
        options: &GraphSearchOptions,
    ) -> serde_json::Value {
...
pub(in crate::product_cli) fn rank_search_hits(hits: &mut [SearchHitRow], query: &str) {
...
pub(in crate::product_cli) fn lexical_score(query: &str, hit: &SearchHitRow) -> f64 {
...
pub(in crate::product_cli) fn entity_priority_score(node_type: &str) -> f64 {
    match node_type {
...
pub(in crate::product_cli) fn round6(value: f64) -> f64 {
