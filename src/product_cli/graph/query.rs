...
pub(in crate::product_cli) fn span_json(
...
pub(in crate::product_cli) fn cypher_single_quoted(value: &str) -> String {
    value.replace('\\', "\\\\").replace('\'', "\\'")
}

pub(in crate::product_cli) fn cypher_identifier(value: &str) -> String {
    value.replace('`', "``")
}

pub(in crate::product_cli) fn value_to_string(value: Option<&Value>) -> String {
    match value {
...
pub(in crate::product_cli) fn value_to_i64(value: Option<&Value>) -> Option<i64> {
    match value {
...
pub(in crate::product_cli) fn value_to_f64(value: Option<&Value>) -> f64 {
    match value {
...
pub(in crate::product_cli) fn validate_read_only_statement(statement: &str) -> Result<(), String> {
...
pub(in crate::product_cli) fn contains_keyword(statement: &str, keyword: &str) -> bool {
...
pub(in crate::product_cli) fn is_keyword_char(character: char) -> bool {
    character.is_ascii_alphanumeric() || character == '_'
}

pub(in crate::product_cli) fn execute_read_only_query(
    db_path: &Path,
    statement: &str,
...
pub(in crate::product_cli) fn lbug_query_parameters(
    parameters: &serde_json::Map<String, serde_json::Value>,
...
pub(in crate::product_cli) fn json_parameter_to_lbug_value(
...
pub(in crate::product_cli) fn json_safe_value(value: Value) -> serde_json::Value {
    match value {
