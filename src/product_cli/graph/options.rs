...
#[derive(Debug)]
pub(in crate::product_cli) struct HealthOptions {
...
#[derive(Debug)]
pub(in crate::product_cli) struct GraphQueryOptions {
    pub(in crate::product_cli) statement: String,
    pub(in crate::product_cli) parameters: serde_json::Map<String, serde_json::Value>,
    pub(in crate::product_cli) limit: usize,
    pub(in crate::product_cli) repo_root: PathBuf,
    pub(in crate::product_cli) config: Option<PathBuf>,
    pub(in crate::product_cli) db: Option<PathBuf>,
    pub(in crate::product_cli) manifest: Option<PathBuf>,
...
#[derive(Debug)]
pub(in crate::product_cli) struct MetadataOutputOptions {
    pub(in crate::product_cli) format: String,
    pub(in crate::product_cli) pretty: bool,
    pub(in crate::product_cli) help: bool,
}

impl MetadataOutputOptions {
    pub(in crate::product_cli) fn parse(
        args: &[String],
        command_name: &str,
    ) -> Result<Self, String> {
        let mut options = Self {
...
#[derive(Debug)]
pub(in crate::product_cli) struct ArchitectureQueryOptions {
    pub(in crate::product_cli) output: MetadataOutputOptions,
    pub(in crate::product_cli) group: Option<String>,
}
...
#[derive(Debug)]
pub(in crate::product_cli) struct GraphSearchOptions {
    pub(in crate::product_cli) query: String,
    pub(in crate::product_cli) limit: usize,
    pub(in crate::product_cli) profile: String,
    pub(in crate::product_cli) budget: usize,
    pub(in crate::product_cli) context_limit: usize,
    pub(in crate::product_cli) max_depth: Option<usize>,
    pub(in crate::product_cli) detail: String,
    pub(in crate::product_cli) repo_root: PathBuf,
    pub(in crate::product_cli) config: Option<PathBuf>,
    pub(in crate::product_cli) db: Option<PathBuf>,
    pub(in crate::product_cli) manifest: Option<PathBuf>,
...
#[derive(Debug)]
pub(in crate::product_cli) struct GraphContextOptions {
    pub(in crate::product_cli) search: GraphSearchOptions,
    pub(in crate::product_cli) node_id: Option<String>,
    pub(in crate::product_cli) node_type: Option<String>,
}
