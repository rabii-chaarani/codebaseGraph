...
pub(in crate::adapters) fn parse_mcp_payload(data: &[u8]) -> Result<serde_json::Value, String> {
...
pub(in crate::adapters) fn rpc_error(
...
pub(in crate::adapters) fn is_supported_protocol_version(version: &str) -> bool {
    matches!(
        version,
