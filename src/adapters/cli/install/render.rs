...
pub(in crate::adapters::cli) struct RenderedNativeConfig {
    pub(in crate::adapters::cli) text: String,
    pub(in crate::adapters::cli) action: String,
    pub(in crate::adapters::cli) entry: serde_json::Value,
    pub(in crate::adapters::cli) patch: serde_json::Value,
    pub(in crate::adapters::cli) payload: serde_json::Value,
}

pub(in crate::adapters::cli) fn render_client_config(
    client: &str,
    scope: &str,
    existing: Option<&str>,
...
pub(in crate::adapters::cli) fn render_json_config(
    adapter: &str,
    existing: Option<&str>,
    descriptor: &NativeMcpDescriptor,
) -> Result<RenderedNativeConfig, String> {
...
pub(in crate::adapters::cli) fn render_codex_config(
    existing: Option<&str>,
    descriptor: &NativeMcpDescriptor,
) -> Result<RenderedNativeConfig, String> {
...
pub(in crate::adapters::cli) fn render_hermes_config(
    existing: Option<&str>,
    descriptor: &NativeMcpDescriptor,
) -> Result<RenderedNativeConfig, String> {
...
pub(in crate::adapters::cli) fn json_container_mut<'a>(
...
pub(in crate::adapters::cli) fn action_for_json(
...
pub(in crate::adapters::cli) fn copilot_studio_metadata(
    descriptor: &NativeMcpDescriptor,
) -> serde_json::Value {
    json!({
...
pub(in crate::adapters::cli) fn codex_toml_block(descriptor: &NativeMcpDescriptor) -> String {
    format!(
        "[mcp_servers.{}]\ncommand = {}\nargs = {}\nstartup_timeout_sec = {}\n",
        descriptor.name,
...
pub(in crate::adapters::cli) fn toml_array(values: &[String]) -> String {
    format!(
        "[{}]",
        values
            .iter()
...
pub(in crate::adapters::cli) fn toml_string(value: &str) -> String {
    format!("\"{}\"", value.replace('\\', "\\\\").replace('"', "\\\""))
}

pub(in crate::adapters::cli) fn upsert_toml_block(
    existing: &str,
    server_name: &str,
    block: &str,
...
pub(in crate::adapters::cli) fn hermes_yaml_block(descriptor: &NativeMcpDescriptor) -> String {
    let mut lines = vec![
...
pub(in crate::adapters::cli) fn yaml_scalar(value: &str) -> String {
    format!("\"{}\"", value.replace('\\', "\\\\").replace('"', "\\\""))
}

pub(in crate::adapters::cli) fn upsert_marked_block(
    existing: &str,
    block: &str,
) -> (String, Option<String>) {
