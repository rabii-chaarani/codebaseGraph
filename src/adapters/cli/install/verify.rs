...
pub(in crate::adapters::cli) fn verify_client_visibility(
    client: &str,
    server_name: &str,
) -> serde_json::Value {
...
pub(in crate::adapters::cli) fn parse_stdio_json_lines(data: &[u8]) -> Vec<serde_json::Value> {
...
pub(in crate::adapters::cli) fn stdio_checks(
...
pub(in crate::adapters::cli) fn visibility_command(client: &str) -> Option<Vec<String>> {
    match client {
        "codex" => Some(vec![
            "codex".to_string(),
            "mcp".to_string(),
