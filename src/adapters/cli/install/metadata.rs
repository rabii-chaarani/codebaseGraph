...
pub(in crate::adapters::cli) fn default_client_config_path(
    client: &str,
    scope: &str,
...
pub(in crate::adapters::cli) fn supported_install_clients() -> Vec<&'static str> {
    vec![
        "claude",
        "claude-project",
        "codex",
...
pub(in crate::adapters::cli) fn supported_install_clients_with_all() -> Vec<&'static str> {
    let mut clients = supported_install_clients();
    clients.push("all");
    clients
}

pub(in crate::adapters::cli) fn install_scope(client: &str, scope: &str) -> String {
...
pub(in crate::adapters::cli) fn adapter_id<'a>(client: &'a str, scope: &str) -> &'a str {
...
pub(in crate::adapters::cli) fn native_client_command(
    client: &str,
    descriptor: &NativeMcpDescriptor,
    scope: &str,
) -> Option<Vec<String>> {
