...
#[derive(Debug, Clone)]
pub(in crate::adapters::cli) struct NativeMcpDescriptor {
    pub(in crate::adapters::cli) name: String,
    pub(in crate::adapters::cli) command: String,
    pub(in crate::adapters::cli) args: Vec<String>,
    pub(in crate::adapters::cli) setup_config_path: String,
    pub(in crate::adapters::cli) repo_root: String,
    pub(in crate::adapters::cli) timeout: u64,
}

impl NativeMcpDescriptor {
    pub(in crate::adapters::cli) fn as_json(&self) -> serde_json::Value {
        json!({
            "name": self.name,
            "transport": "stdio",
    ...
    pub(in crate::adapters::cli) fn stdio_entry(
        &self,
        include_type: bool,
...
pub(in crate::adapters::cli) fn build_mcp_descriptor(
...
pub(in crate::adapters::cli) fn install_safe_name(value: &str) -> String {
