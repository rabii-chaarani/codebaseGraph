...
pub(crate) struct ArchitectureQueryOptions {
    ...
    pub(in crate::adapters::cli) group: Option<String>,
}
...
pub(crate) struct GraphContextOptions {
    pub(in crate::adapters::cli) search: GraphSearchOptions,
    pub(in crate::adapters::cli) node_id: Option<String>,
    pub(in crate::adapters::cli) node_type: Option<String>,
}
