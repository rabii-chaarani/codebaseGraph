...
#[derive(Debug)]
pub(in crate::adapters::cli) struct WatchOptions {
    pub(in crate::adapters::cli) materialize: MaterializeOptions,
    pub(in crate::adapters::cli) backend: WatchBackend,
    pub(in crate::adapters::cli) poll_ms: u64,
    pub(in crate::adapters::cli) debounce_ms: u64,
    pub(in crate::adapters::cli) max_iterations: Option<usize>,
    pub(in crate::adapters::cli) once: bool,
    pub(in crate::adapters::cli) help: bool,
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::adapters::cli) enum WatchBackend {
    Auto,
    Native,
    Poll,
}
...
impl WatchBackend {
    pub(in crate::adapters::cli) fn parse(value: &str) -> Result<Self, String> {
        match value {
            "auto" => Ok(Self::Auto),
...
#[derive(Debug)]
pub(in crate::adapters::cli) struct SetupOptions {
