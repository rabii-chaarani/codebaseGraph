...
BUILTIN_LANGUAGE_PROFILES = (
    ...
    _profile(
        ...
        (
            ...
            _capture("definition.struct", ("struct_type",), "Class", ("Defines",), construct="struct_type"),
            _capture("definition.interface", ("interface_type",), "Class", ("Defines",), construct="interface_type"),
    ...
    _profile(
        ...
        (
            ...
            _capture("reference.call", ("call_statement",), "CallExpression", ("Calls",)),
        ),
