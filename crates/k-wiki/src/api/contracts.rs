...
use crate::{
    ...
    memory::{
        MemoryRecallResult, MemoryRecord, RecallMemoryRequest, RecordMemoryRequest,
...
pub enum WikiOperationRequest {
    ...
    RecordMemory(RecordMemoryRequest),
    RecallMemory(RecallMemoryRequest),
    TransitionMemory(TransitionMemoryRequest),
...
pub enum WikiOperationResponse {
    ...
    MemoryRecorded(MemoryRecord),
    MemoryRecalled(Vec<MemoryRecallResult>),
    MemoryTransitioned(MemoryRecord),
